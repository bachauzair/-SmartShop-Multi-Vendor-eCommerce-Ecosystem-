            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                    <div class="copyright-text">
                        ...
                        <?php } else { ?>
                            <p>Copyright &copy; <?= date('Y') - 1  ?> - <?= date('Y') ?>, All Right Reserved SmartShop</p>
                        <?php } ?>
                    </div>
                </div>
            </div>
    ...
    <div class="row p-4">
        ...
        <div class="col-12 col-sm-6 product-page-details">
            ...
            <div class="pb-2 text-center text-md-left">
                ...
                <div class="button button-sm m-0 p-0">
                    <button class="buttons btn-6-1 extra-small m-0 add-fav mt-1" id="add_to_favorite_btn"><i class="far fa-heart"></i> <span><?= !empty($this->lang->line('add_to_favorite')) ? $this->lang->line('add_to_favorite') : 'Add to Favorite' ?></span></button>
                </div>
            </div>
