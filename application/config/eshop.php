...
$config['notification_modules'] = [ 
    ...
    'customer_order_received' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_processed' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_shipped' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_delivered' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_cancelled' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_returned' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_returned_request_decline' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'customer_order_returned_request_approved' => array('customer', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
    'delivery_boy_order_deliver' => array('customer', 'admin', 'seller', 'delivery_boy','notification_via_sms','notification_via_mail'),
