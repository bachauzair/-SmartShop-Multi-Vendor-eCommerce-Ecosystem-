...
class Orders extends CI_Controller
{
    ...
    public function edit_orders()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_delivery_boy()) {
            ...
            $this->data['meta_description'] = 'SmartShop | View Order | ' . $settings['app_name'];
            $res = $this->Order_model->get_order_details(['o.id' => $_GET['edit_id'], 'oi.delivery_boy_id' => $delivery_boy->id]);
